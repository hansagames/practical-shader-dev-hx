...
class SpriteSheet extends BaseOfApp {
	...
	override private function setup():Void {
		...
		charShader.setUniformTexture("greenMan", Webpack.require("../../original/ch4/5_SpritesheetAnimation/bin/data/walk_sheet.png"), 0, 0);
		cloudShader = new Material(ctx);
		cloudShader.load(
			Webpack.require("./shaders/cloud.vert.glsl"),
			Webpack.require("./shaders/cloud.frag.glsl")
		);
		cloudShader.setUniformTexture("cloud", Webpack.require("../../original/ch4/Assets/cloud.png"), 2);
		sunShader = new Material(ctx);
		sunShader.load(
			Webpack.require("./shaders/sun.vert.glsl"),
			Webpack.require("./shaders/sun.frag.glsl")
		);
		sunShader.setUniformTexture("sun", Webpack.require("../../original/ch4/Assets/sun.png"), 3);
